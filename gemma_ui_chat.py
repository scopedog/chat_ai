#
# This code sets up a basic AI assistant using chainlit and Gemma.
# It initializes a Gemma model and defines event handlers for chat start and incoming messages.
#
...
#
# To run:
#     chainlit run gemma_ui_chat.py --host 0.0.0.0
#
